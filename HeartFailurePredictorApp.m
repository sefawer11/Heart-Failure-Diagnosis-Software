function HeartFailurePredictionGUI()
    ...
    function createModernFooter()
        ...
        if isfield(handles, 'models') && ~isempty(handles.models)
            perfText = sprintf('Model Accuracy: Baseline %.1f%% | Dropout %.1f%% | Early-Stop %.1f%% | L2-Reg %.1f%%', ...
                               ...
                               handles.models.metrics_l2_test.Accuracy*100);
        else
    ...
    function predictCallback(~, ~)
        ...
        modelNames = {'baseline', 'dropout', 'earlystop', 'l2'};
    ...
    function result = performPrediction(patientData, modelType, models)
        ...
        switch modelType
            ...
            case 'l2'
                ...
                y_prob = net(X_norm')';
                if numel(y_prob) > 1, y_prob = y_prob(1); end
                modelName = 'L2 Regularization';
                metrics = models.metrics_l2_test;
        end
